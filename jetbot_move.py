...
# Example of how to move the jetbot in the Isaac Sim environment
...
# start the Isaac Sim application in display mode (this only works for local install otherwise start headless)
